export default {
  common: {
    ...
    change: '更改',
    select: '选择',
    incompleteTranslations: '未填写的语言：{langs}'
  },
  header: {
  ...
  addDialog: {
    ...
    publisherLabel: '发行商',
    publisherPlaceholder: '选择或搜索发行商',
    publisherHint: '开发商与发行商只填写其中一项时，另一项将保存为相同的值',
    ...
    memoHint: '仅供参考的备注，不包含在搜索中。支持 Markdown 格式',
    selectImage: '从文件选择',
    imageUrl: '图片 URL',
    fetchUrl: '获取',
    dropHere: '拖放到此处',
  ...
  tag: {
    ...
    namePlaceholder: '输入名称',
    keywordLabel: '搜索关键词',
    keywordPlaceholder: '搜索关键词（可选）',
    keywordHint: '不会显示在界面上，仅用于搜索',
    deleteConfirmTitle: '删除标签',
    deleteConfirmMessage: '确定删除“{name}”吗？使用该标签的项目将解除关联。',
    added: '已添加标签',
    updated: '已更新标签',
    deleted: '已删除标签',
    saveFailed: '保存失败'
